...
When the target class has only two unique values, we perform [**binary classification**](./binary.qmd), whereas when the target class has more than two unique values, we perform [**multiclass classification**](./multiclass.qmd).
