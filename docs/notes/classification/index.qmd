...
When the target is binary, we will perform a ["binary classification" task](./binary.ipynb). When the target is categorical, we will perform a ["multi-class classification" task](multiclass.qmd).
