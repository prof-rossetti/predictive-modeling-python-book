...
**Auto-Regressive Integrated Moving Average (ARIMA)** is a "method for forecasting or predicting future outcomes based on a historical time series. It is based on the statistical concept of serial correlation, where past data points influence future data points."[@investopedia_arima; @Liu2020] - [Source: Investopedia](https://www.investopedia.com/terms/a/autoregressive-integrated-moving-average-arima.asp)
...
(As noted by Kaur et al. [@kaur_autoregressive_models], autoregressive models are particularly valuable in various domains, including environmental forecasting, where understanding temporal dependencies can significantly improve predictive accuracy.)

In practice, ARIMA models may be better at short term forecasting, and may not perform as well in forecasting over the long term[@Liu2020].
