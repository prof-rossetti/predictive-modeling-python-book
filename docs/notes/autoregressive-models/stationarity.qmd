...
There are different types of stationarity, including[@shumway_stoffer_time_series]:
...
In time series analysis, stationarity is a key assumption that greatly influences our choice of which models to use[@hyndman_forecasting].
...
If your data is non-stationary, here are a few common techniques to make it stationary[@science_direct_arima_garch]:
